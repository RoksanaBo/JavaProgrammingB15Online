...
public class ArrayTask_NumberMoreThan100 {

    public static void main(String[] args) {

        // given an int array write a program to
        //test all elements in this int array are more than 100

        int[] scores = {156,101,76,187,87,110} ;

        // create a variable called finalResult to store your result of
        // checking if every number in this array is more than 100 or not
