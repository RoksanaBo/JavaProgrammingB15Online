...
public class FruitShop {
    ...
    // Only Reference Type decide what you
    // can access at compile time
    // if we have Fruit as reference type ,
    // getDigested method will point to the one under Fruit class
    // Actual object type decide what method will be called at run time
    // since actual object is Apple|Orange , at run time it
    // will call Override version of the method
    // and that's the power of polymorphism , making the
    // correct decision at runtime according to the actual object
    ...
    public static void main(String[] args) {
        ...
        // a1 has Apple as reference type , so we can
        // access anything inside Apple
...
//        f1.type   // we can not access type coming from Apple if we refer it as Fruit
        ...
        System.out.println(f1.toString()  );  // toString mojno ne pisat'
