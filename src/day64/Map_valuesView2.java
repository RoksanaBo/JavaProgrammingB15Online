...
public class Map_valuesView2 {
    ...
    public static void main(String[] args) {
        ...
        // remove all entry ot the groceryPriceMap
        // if the price value is more than 3:
        allPrices.removeIf(eachPrice-> eachPrice > 3);
        System.out.println("groceryPriceMap = " + groceryPriceMap);

        // The logic is to use the strict connection between
        // the view and the original map
        // iterate over the allPrices and check the condition
        // for more than 3 or not, if it is more than 3 than remove
