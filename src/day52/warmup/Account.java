...
public class Account implements Transferable, Comparable<Account> {
    ...
    public void transferAll(Account otherAccount) {
        ...
        otherAccount.balance += this.balance; // otherAccount.balance =otherAccount.balance + this.balance;
...
//        withdraw( balance );
    ...
    public boolean isPalindrome() {
        ...
        // first store it into temp and replace
        // all the space and make it lowercase
        // WE DO NOT WANT TO ACTUALLY CHANGE THE NAME
        // OF THE ACCOUNT  SO WE JUST WORK WITH IT'S COPY

        String nameCopy = this.name.toLowerCase().replace(" ", "");

        // we need to reverse the value then check
        // whether they are still same String or not
