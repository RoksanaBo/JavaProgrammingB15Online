...
public class AccountListSorting {
    ...
    public static void main(String[] args) {
        ...
        List<Account> accountList = new ArrayList<>();             // it stores Account object
        ...
        Account myAccount = new Account("Roksana", 0);
...
/*        What can be the data type of a1
  ...
  */
        Account a1 = new Account("Polymorphism 1", 10000);

        Transferable t1 = new Account("Polymorphism 2", 10000);     //   interface type

        Comparable c1 = new Account("Polymorphism 3", 10000);

        Object o1 = new Account("Polymorphism 4", 10000);
