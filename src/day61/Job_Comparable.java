...
public class Job_Comparable implements Comparable<Job_Comparable> {
    ...
    public Job_Comparable(String location, double salary, String companyName) {
    ...
    @Override
    public int compareTo(Job_Comparable other) {  // we provide the logic, which salary is higher
