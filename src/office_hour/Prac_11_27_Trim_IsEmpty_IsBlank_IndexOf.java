...
public class Prac_11_27_Trim_IsEmpty_IsBlank_IndexOf {
    public static void main(String[] args) {

        // Trim takes out spaces at the beginning and ending of a String object
        //trim  does not take out the space in between characters,ONLY 2 sides
        ...
        System.out.println("emptySpacesAfterTrim length is : = " + emptySpacesAfterTrimmed.length());
        System.out.println("emptySpacesAfterTrim length is empty??  :  " + emptySpacesAfterTrimmed.isEmpty());
