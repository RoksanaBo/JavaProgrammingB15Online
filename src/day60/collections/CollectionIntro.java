...
public class CollectionIntro {
    ...
    public static void main(String[] args) {
        ...
        // with this assignment we can access only
        // what Collection interface have
        // so we can learn what any type of Collection
        // including Set , Queue , List have in common
        names.add("Hasan");
        names.add("Sevim");
        names.add("Abdullo");
        names.add("Tuana");
        names.add("Daria");
        names.add("Lorin");
        names.addAll(names); // addAll method parameter type is Collection(interface)
                             // so we can pass anything IS-A Collection
...
//        names.remove("Hasan");
        ...
        // quickly generating a type of List object
        // and assign it to super type Collection :
